...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { inout: @history.inout, user_id: @history.user_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { inout: @history.inout, user_id: @history.user_id } }
